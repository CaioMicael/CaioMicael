...
## 🔹 [LogAnalyzer](https://github.com/CaioMicael/LogAnalyzer)
...
Aplicação web para **gerenciamento de consultas médicas**, construída com arquitetura moderna baseada em **Domain-Driven Design (DDD)**.
